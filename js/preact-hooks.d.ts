/**
 * Type definitions for Preact hooks
 * Yanked from https://esm.sh/v135/preact@10.25.4/hooks/src/index.d.ts
 */
declare module 'https://esm.sh/preact/hooks' {
    // Intentionally not using a relative path to take advantage of
    // the TS version resolution mechanism
    import { ErrorInfo, PreactContext, Ref, RefObject } from 'https://esm.sh/v135/preact@10.25.4/src/index.d.ts';
